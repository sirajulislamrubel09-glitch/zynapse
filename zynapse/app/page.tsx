...
// ============================================================
//  ZYNAPSE — LANDING PAGE (CLEAN REBUILD)
//  File: app/page.tsx
//  Features:
//  ✅ Touch/click glow effect (like capsulehub)
//  ✅ Proper mobile sizing
//  ✅ Clean sections - not over-designed
//  ✅ Smooth animations
//  ✅ Pricing, Features, FAQ, Footer
// ============================================================
...
// ════════════════════════════════════════════════════════════
//  TOUCH GLOW EFFECT
//  Creates a lime glow orb wherever the user clicks/taps
// ════════════════════════════════════════════════════════════
function TouchGlow() {
        ...
        {ripples.map(r => (
          <motion.div
            ...
            style={{
              ...
              height: 100,
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(170,255,0,0.35) 0%, rgba(170,255,0,0.08) 50%, transparent 70%)',
              pointerEvents: 'none',
            }}
          />
        ))}
...
// ─── Ticker text ─────────────────────────────────────────────
const TICKS = [
  '10K+ Users', '4.9 Star Rating', '50K+ Workouts',
  '98% Accuracy', 'AI-Powered', 'Free to Start',
  '10K+ Users', '4.9 Star Rating', '50K+ Workouts',
  '98% Accuracy', 'AI-Powered', 'Free to Start',
]
...
const FEATURES = [
  {
    icon: Dumbbell, color: L, bg: 'rgba(170,255,0,0.07)',
    label: 'WORKOUT', title: 'Smart Workout Tracker',
    desc: 'Log sets, reps, weights. AI adjusts your next session based on your recovery data.',
  },
  {
    icon: Camera, color: '#FF6B35', bg: 'rgba(255,107,53,0.07)',
    label: 'FOOD AI', title: 'Snap & Track Meals',
    desc: 'Photo your plate. AI reads it in 2 seconds — calories, protein, carbs, fat. No typing.',
  },
  {
    icon: Brain, color: '#A78BFA', bg: 'rgba(167,139,250,0.07)',
    label: 'DETOX', title: 'Dopamine Detox Hub',
    desc: 'Track triggers, build streaks, run focus sessions. Break bad habits permanently.',
  },
  {
    icon: TrendingUp, color: CYN, bg: 'rgba(0,212,255,0.07)',
    label: 'GAMIFIED', title: 'Discipline Score',
    desc: 'Earn XP for every healthy habit. Level up. Top the leaderboard. Make discipline addictive.',
  },
]
...
const FAQS = [
  ...
  { q: 'How does the meal photo scanner work?', a: 'Take a photo of any food. Our Groq AI identifies it and returns full nutrition data in under 2 seconds. Like magic.' },
...
export default function Page() {
  ...
  return (
    <>
      {/* Touch glow effect — appears on every click/tap */}
      <TouchGlow />

      <div style={{ background: BG, color: '#fff', overflowX: 'hidden', fontFamily: 'var(--font-syne), sans-serif' }}>
        <style>{`
        ...
        >
          <div className="flex items-center justify-between px-4 py-3 max-w-5xl mx-auto">
            ...
            <div className="hidden md:flex items-center gap-6">
              {['Features', 'Pricing', 'FAQ'].map(l => (
                <a key={l} href={`#${l.toLowerCase()}`}
                  style={{ color: SUB, fontSize: 13, fontWeight: 600 }}
            ...
            <div className="flex items-center gap-2">
              <Link href="/login"
                className="hidden md:block text-sm font-semibold px-3 py-2 hover:text-white transition-colors"
                style={{ color: SUB }}>
                Log in
              </Link>
              <Link href="/signup"
              ...
              >
                <div style={{ width: 16, height: 10, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                  <div style={{ height: 1.5, background: '#fff', borderRadius: 2 }} />
                  <div style={{ height: 1.5, background: '#fff', borderRadius: 2, width: '70%' }} />
                  <div style={{ height: 1.5, background: '#fff', borderRadius: 2 }} />
                </div>
              </button>
            </div>
          ...
          <AnimatePresence>
            {menuOpen && (
              <motion.div
                ...
                style={{ overflow: 'hidden', borderTop: `1px solid ${BD}` }}
              >
        ...
        <section className="relative overflow-hidden pt-14">
          ...
          <div className="max-w-md mx-auto px-5 flex flex-col items-center text-center pt-8 pb-6">
            ...
            >
              ...
              />
              <span style={{ color: L, fontSize: 10, fontWeight: 700, letterSpacing: '0.2em' }}>
            ...
            <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
              <h1 style={{ fontSize: 22, fontWeight: 900, letterSpacing: '0.2em', color: '#fff', marginBottom: 4 }}>
                ZYNAPSE
              </h1>
              <p style={{ color: CYN, fontSize: 9, fontWeight: 700, letterSpacing: '0.3em', marginBottom: 18 }}>
                AI FOR A BETTER YOU
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ width: '100%', maxWidth: 280, height: 260 }}
            >
              {/* Glow rings — contained, no overflow */}
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                {[200, 160, 124].map((s, i) => (
                  <motion.div key={i}
                    ...
                    style={{
                      width: s, height: s,
                      border: `1px solid ${i < 2 ? 'rgba(170,255,0,0.2)' : 'rgba(0,212,255,0.12)'}`,
                    }}
                  />
                ))}
              ...
              {/* Body-builder image — properly clipped */}
          ...
          <div className="max-w-md mx-auto">
            <FadeUp className="mb-8">
              ...
              <h2 style={{ fontSize: 22, fontWeight: 900, lineHeight: 1.2 }}>
                Four systems.<br /><span style={{ color: L }}>One platform.</span>
              </h2>
            </FadeUp>
        ...
        {/* ══════════════════════════════════════════════════
            DISCIPLINE SCORE SHOWCASE
        ══════════════════════════════════════════════════ */}
        <section className="py-12 px-5 max-w-md mx-auto">
          <FadeUp className="mb-6">
            <p style={{ color: L, fontSize: 10, fontWeight: 700, letterSpacing: '0.2em', marginBottom: 6 }}>ONLY ON ZYNAPSE</p>
            <h2 style={{ fontSize: 22, fontWeight: 900, lineHeight: 1.2, marginBottom: 8 }}>
              Your Discipline Score.<br /><span style={{ color: L }}>Your identity.</span>
            </h2>
            <p style={{ color: SUB, fontSize: 13, lineHeight: 1.65 }}>
              Every healthy action earns XP. Hit calorie goals, complete workouts, maintain streaks —
              your score climbs. It keeps you honest. It keeps you motivated.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.1}>
            <div className="p-5 rounded-2xl" style={{ background: C2, border: `1px solid ${BD}` }}>
              ...
              <div className="flex items-center justify-between mb-5">
                <div>
                  <p style={{ color: CYN, fontSize: 9, fontWeight: 700, letterSpacing: '0.15em', marginBottom: 4 }}>
                    DISCIPLINE SCORE
                  </p>
                  <p style={{ fontSize: 36, fontWeight: 900, color: '#fff', lineHeight: 1 }}>
                    92<span style={{ fontSize: 16, color: MUT }}>/100</span>
                  </p>
                  <p style={{ color: L, fontSize: 11, marginTop: 3 }}>⚡ Top 5% this week</p>
                </div>
                {/* Ring */}
                <div style={{ position: 'relative', width: 70, height: 70 }}>
                  <svg viewBox="0 0 70 70" style={{ width: '100%', height: '100%', transform: 'rotate(-90deg)' }}>
                    <circle cx="35" cy="35" r="28" fill="none" stroke={BD} strokeWidth="7" />
                    <motion.circle cx="35" cy="35" r="28" fill="none" stroke={L} strokeWidth="7"
                      strokeLinecap="round"
                      strokeDasharray={`${2 * Math.PI * 28}`}
                      initial={{ strokeDashoffset: 2 * Math.PI * 28 }}
                      whileInView={{ strokeDashoffset: 2 * Math.PI * 28 * 0.08 }}
                      viewport={{ once: true }}
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl mb-4"
                style={{ background: 'rgba(170,255,0,0.05)', border: `1px solid rgba(170,255,0,0.12)` }}>
                <div className="w-9 h-9 rounded-full flex items-center justify-center text-xs font-black flex-shrink-0"
                  style={{ background: L, color: '#000' }}>12</div>
                <div>
                  <div style={{ color: '#fff', fontWeight: 700, fontSize: 13 }}>Level 12 — Elite</div>
                  <div style={{ color: MUT, fontSize: 11 }}>3,200 XP · Next level 3,500</div>
                </div>
              </div>
              ...
              <div className="flex justify-between mt-1.5">
                <span style={{ color: MUT, fontSize: 10 }}>3,200 XP</span>
                <span style={{ color: MUT, fontSize: 10 }}>3,500 XP</span>
              </div>
            </div>
          </FadeUp>
        </section>
        ...
        {/* ══════════════════════════════════════════════════
            HOW IT WORKS
        ══════════════════════════════════════════════════ */}
        <section id="how-it-works" className="py-12 px-5" style={{ background: C1 }}>
          <div className="max-w-md mx-auto">
            <FadeUp className="mb-8">
              ...
              <h2 style={{ fontSize: 22, fontWeight: 900 }}>
                Ready in <span style={{ color: L }}>2 minutes.</span>
              </h2>
            </FadeUp>
            <div className="flex flex-col gap-3">
              {STEPS.map((s, i) => (
        ...
        <section className="py-12 px-5 max-w-md mx-auto">
          <FadeUp className="mb-8">
            <h2 style={{ fontSize: 22, fontWeight: 900 }}>
              Real people. <span style={{ color: L }}>Real results.</span>
            </h2>
          </FadeUp>
          <div className="flex flex-col gap-3">
            {REVIEWS.map((r, i) => (
              <FadeUp key={i} delay={i * 0.08}>
                <div className="p-4 rounded-2xl" style={{ background: C2, border: `1px solid ${BD}` }}>
                  ...
                  <p style={{ color: '#ccc', fontSize: 13, lineHeight: 1.65, marginBottom: 10 }}>
                    &ldquo;{r.text}&rdquo;
                  </p>
        ...
        {/* ══════════════════════════════════════════════════
            PRICING
        ══════════════════════════════════════════════════ */}
        <section id="pricing" className="py-12 px-5" style={{ background: C1 }}>
          <div className="max-w-md mx-auto">
            <FadeUp className="mb-8">
              ...
              <h2 style={{ fontSize: 22, fontWeight: 900, marginBottom: 14 }}>
                Simple. <span style={{ color: L }}>Fair.</span>
              </h2>
              {/* Toggle */}
              <div className="inline-flex p-1 rounded-xl gap-1" style={{ background: C2 }}>
                {(['Monthly', 'Yearly'] as const).map(p => (
                  <button key={p} type="button"
                    ...
                    style={{
                      background: (p === 'Yearly') === yearly ? L : 'transparent',
                      color: (p === 'Yearly') === yearly ? '#000' : SUB,
                    }}>
            ...
            <div className="flex flex-col gap-4">
              ...
              <FadeUp>
                <div className="p-5 rounded-2xl" style={{ background: C2, border: `1px solid ${BD}` }}>
                  ...
                  <div style={{ fontSize: 36, fontWeight: 900, color: '#fff', marginBottom: 16 }}>
                    0 <span style={{ fontSize: 13, color: SUB, fontWeight: 400 }}>BDT forever</span>
                  </div>
                  <div className="flex flex-col gap-2.5 mb-5">
                    {['AI meal analysis', 'Basic workout tracking', '3 detox triggers', 'Daily calorie goal', 'Discipline score'].map(f => (
                      <div key={f} className="flex items-center gap-2">
                        <Check size={13} color={MUT} />
              ...
              <FadeUp delay={0.1}>
                <div className="p-5 rounded-2xl relative" style={{ background: 'rgba(170,255,0,0.04)', border: `2px solid ${L}` }}>
                  <div className="absolute -top-3 left-5 px-3 py-1 rounded-full text-xs font-black"
                    style={{ background: L, color: '#000' }}>MOST POPULAR</div>
                  ...
                  <div style={{ fontSize: 36, fontWeight: 900, color: '#fff', marginBottom: 4 }}>
                    {yearly ? '699' : '199'}{' '}
                    <span style={{ fontSize: 13, color: SUB, fontWeight: 400 }}>BDT / {yearly ? 'year' : 'month'}</span>
                  </div>
                  {yearly && <p style={{ color: L, fontSize: 11, marginBottom: 12 }}>Only 58 BDT/month!</p>}
                  <div className="flex flex-col gap-2.5 mb-5 mt-4">
                    {['Everything in Free', 'Save unlimited meal photos', 'Unlimited workout plans', 'Advanced AI coaching', 'Progress analytics', 'No ads. Ever.'].map(f => (
                      <div key={f} className="flex items-center gap-2">
                        <Check size={13} color={L} />
                        <span style={{ color: '#ddd', fontSize: 13 }}>{f}</span>
                      </div>
                    ))}
                  </div>
                  <Link href="/signup?plan=premium"
                    className="block w-full py-3.5 rounded-xl text-center font-black text-sm transition-all active:scale-95"
                    style={{ background: L, color: '#000', boxShadow: '0 0 20px rgba(170,255,0,0.18)' }}>
                    Get Premium
                  </Link>
                  <p className="text-center mt-2" style={{ color: MUT, fontSize: 11 }}>
        ...
        {/* ══════════════════════════════════════════════════
            FAQ
        ══════════════════════════════════════════════════ */}
        <section id="faq" className="py-12 px-5 max-w-md mx-auto">
          <FadeUp className="mb-8">
            <h2 style={{ fontSize: 22, fontWeight: 900 }}>
              Got <span style={{ color: L }}>questions?</span>
            </h2>
          </FadeUp>
        ...
        {/* ══════════════════════════════════════════════════
            FINAL CTA
        ══════════════════════════════════════════════════ */}
        <section className="py-16 px-5" style={{ background: C1 }}>
          <div className="max-w-md mx-auto text-center">
            <FadeUp>
              ...
              <p style={{ color: SUB, fontSize: 13, marginBottom: 22, lineHeight: 1.65 }}>
                Join 10,000+ users already training smarter, eating better, and living more focused.
              </p>
              <Link href="/signup"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl font-black text-sm tracking-widest transition-all hover:opacity-90 active:scale-95"
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              {[
                ...
                <div key={col.t}>
                  ...
                  {col.ls.map(l => (
                    <a key={l} href="#" className="block mb-1.5 hover:text-white transition-colors"
                      style={{ color: MUT, fontSize: 11 }}>{l}</a>
                  ))}
                </div>
              ))}
            </div>
